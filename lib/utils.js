...
var utils = module.exports = {
   ...
   */
  socketReconnectionLogic: function (socket, clientStream, initializeStream) {
    ...
    socket.on('offline', disconnected)
  ...
  getRepositoryForCurrentDirectory: Promise.method(function () {
    ...
    return Promise.props({
      ...
      .then(function (results) {
        ...
        var origin = parseGithubURL(keypather.get(results, 'origin.refs.push'))
        if (!origin) {
